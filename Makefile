...
SOURCES		:=	$(UNIVCORE) source source/gui source/screens source/screens/local source/utils
DATA		:=	data
INCLUDES	:=	$(UNIVCORE) include include/gui include/screens include/screens/local include/utils
GRAPHICS	:=	assets/gfx
ROMFS		:=	romfs
GFXBUILD	:=	$(ROMFS)/gfx
